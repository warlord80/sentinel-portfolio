...
import { getProjects, getWriteups, getCertifications, getExperience } from "@/app/actions/content";
...
export default async function Home() {
  ...
  try {
    [socialLinks, resumeUrl, projects, writeups, certifications, experiences] = await Promise.all([
